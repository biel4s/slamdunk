...
export const Cards: Card[] = [
  ...
  },
  {
    ...
    description: "Slask Wroclaw waited 11 months for this day. The end of a dramatic series. Almost a year has passed since Slask Wroclaw basketball players last won the EuroCup. They broke the black series of seventeen defeats in a row in Ankara, beating Turk Telekom there 80:71. A great game was played by Jakub Niziol, but he was not the hero.",
    type: "Trending",
    url: "filip-petrusev-returns-to-europe"
  },
  {
