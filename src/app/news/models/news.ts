...
export const Cards: NewsCardModel[] = [
  ...
  },
  {
    ...
    subtitle: "Highlighting the Performance of the Player of the Week in Round 8 of EuroCup",
  ...
  },
  {
    ...
    secondDescription: "The upcoming EuroLeague match between Barcelona and Maccabi Tel Aviv is shaping up to be a pivotal one. The absence of key players Jan Vesely and Rokas Jokubaitis from Barcelona's lineup could potentially boost Maccabi's chances against the Spanish powerhouse. Vesely, known for his scoring prowess, and Jokubaitis, a versatile player capable of switching positions, are vital assets for Barcelona. Their absence could leave a gap in Barcelona's attacking and defensive capabilities, providing an opportunity for Maccabi to exploit. On the other hand, Barcelona's current form is not at its best. The team is currently in second place in the EuroLeague with seven wins and two losses, but is going through a crisis of sorts. Their top players are experiencing a significant decline in form, and the team's defense needs to be at the level of the first six rounds of the EuroLeague to have any hope of positive results. ",
    thirdDescription: "Despite these challenges, Maccabi Tel Aviv has shown resilience and determination. They hold a 5-3 record despite playing one less game in the EuroLeague due to the situation in Israel. Their last win came against Fenerbahce after a comeback, demonstrating their ability to overcome adversity. However, the outcome of the match will ultimately depend on how well Maccabi can capitalize on this opportunity and how well Barcelona can manage without their key players.",
    type: "Trending",
